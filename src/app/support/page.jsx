...
export default function SupportPage() {
  return (
    <div className="bg-[#050505] text-white min-h-screen py-8 md:py-14">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          ...
          <h1 className="text-2xl sm:text-4xl font-black text-white tracking-tight mt-3">
        ...
        <div className="p-5 rounded-3xl bg-gradient-to-r from-[#170B04] via-[#0F0F0F] to-[#0A0A0A] border border-[#FF5B00]/30 flex flex-col sm:flex-row items-center justify-between gap-4 mb-8 shadow-xl">
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto">
            <a
              ...
              className="flex-1 sm:flex-initial py-2.5 px-4 rounded-xl bg-[#141414] hover:bg-[#1E1E1E] border border-[#2A2A2A] text-xs font-bold text-white flex items-center justify-center gap-2 transition-colors"
            >
            ...
            <a
              ...
              className="flex-1 sm:flex-initial py-2.5 px-4 rounded-xl bg-[#25D366] hover:bg-[#20bd5a] text-black font-black text-xs uppercase tracking-wide flex items-center justify-center gap-2 shadow-md transition-transform active:scale-95"
            >
        ...
        <div className="text-center mt-10">
          <Link
            href="/"
            className="inline-flex items-center gap-2 py-3 px-6 rounded-2xl bg-[#141414] hover:bg-[#1E1E1E] text-neutral-300 hover:text-white border border-[#262626] font-bold text-xs transition-colors"
          >
