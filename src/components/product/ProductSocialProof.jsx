  ...
  return (
    <div className="flex flex-col gap-2 w-full my-2">
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
        {/* 1. Baxanlar */}
        <div className="flex items-center gap-1.5 p-2 rounded-xl bg-[#120803] border border-[#FF5B00]/25 text-center justify-center">
        ...
        {/* 2. Satılan */}
        <div className="flex items-center gap-1.5 p-2 rounded-xl bg-[#09150F] border border-[#10B981]/25 text-center justify-center">
          <p className="text-[11px] text-neutral-300 truncate">
            🔥 <strong className="text-red-500 font-black">{soldLast24Hours}</strong> satıldı
          </p>
        </div>

        {/* 3. Bəyənmə */}
        <div className="flex items-center gap-1.5 p-2 rounded-xl bg-[#140D14] border border-pink-500/25 text-center justify-center">
          <p className="text-[11px] text-neutral-300 truncate">
            ❤️ <strong className="text-pink-400 font-black">{likes}</strong> bəyəndi
          </p>
        </div>
      </div>

      {/* Kompakt Stok Təciliyi Zolağı */}
      <div className="px-3 py-2 rounded-xl bg-[#100702] border border-[#FF5B00]/30 flex items-center justify-between gap-2 text-xs">
